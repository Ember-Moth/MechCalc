...
MechCalc 1.0 is the first stable release of the local-first Android calculation toolbox.

MechCalc 1.0 是本地优先 Android 计算工具箱的第一个正式稳定版。
...
- Removed unused network permission. MechCalc remains offline and local-first.
- 移除了未使用的网络权限。MechCalc 保持离线、本地优先。

## Assets / 下载包

- `MechCalc-v1.0.0+6-arm64-v8a.apk` for most modern Android phones.
- `MechCalc-v1.0.0+6-armeabi-v7a.apk` for older 32-bit Android devices.
- `MechCalc-v1.0.0+6-x86_64.apk` for x86_64 Android environments.
- `MechCalc-v1.0.0+6-universal.apk` if you need one APK for every supported ABI.

## Checksums / SHA-256

```text
587dd2fed733b1489b413bcf3c64e4889e5f5e997e0787791e6e04f300ba3ec7  MechCalc-v1.0.0+6-arm64-v8a.apk
f2646db5791616ca7fea753d195fc920128d6300e42b6008df38ef02c743bcd6  MechCalc-v1.0.0+6-armeabi-v7a.apk
4f34b63839a89401cf17aacd01f857a20e18fb7cbb0ddf18e0c783a216ece321  MechCalc-v1.0.0+6-x86_64.apk
9835a5b773120025d3fa29f0898b484667465b5a4f31431a13ed93757be993d0  MechCalc-v1.0.0+6-universal.apk
```
