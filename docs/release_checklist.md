...
adb shell dumpsys package com.embermoth.mechcalc | rg "versionCode|versionName|lastUpdateTime"
adb shell monkey -p com.embermoth.mechcalc -c android.intent.category.LAUNCHER 1
```

## Release Assets

- `MechCalc-vX.Y.Z+N-arm64-v8a.apk`
- `MechCalc-vX.Y.Z+N-armeabi-v7a.apk`
- `MechCalc-vX.Y.Z+N-x86_64.apk`
- Optional: `MechCalc-vX.Y.Z+N-universal.apk`
