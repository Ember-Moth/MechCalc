...
MechCalc 1.2 beta is a release-candidate style preview that closes the large feature and maintainability work for the next public release.

MechCalc 1.2 beta 是面向下一次公开发布的预览版，集中收口大范围功能完善、细节可靠性和代码解耦工作。
...
MechCalc 1.1 focuses on reliability and professional workflow improvements after the first stable release.

MechCalc 1.1 聚焦正式版后的可靠性和专业工作流增强。
...
MechCalc 1.0 is the first stable release. It focuses on daily reliability, local-first data safety, release packaging, and a smoother scientific calculator workflow.

MechCalc 1.0 是第一个正式稳定版，重点完善日常可用性、本地数据安全、发布打包和科学计算器交互。
