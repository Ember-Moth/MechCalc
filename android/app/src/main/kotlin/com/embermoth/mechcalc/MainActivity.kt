package com.embermoth.mechcalc
...
class MainActivity : FlutterActivity() {
    private val backupChannelName = "mechcalc/backup_file"
    private val hapticsChannelName = "mechcalc/haptics"
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, backupChannelName).setMethodCallHandler { call, result ->
            when (call.method) {
                "exportJson" -> {
                    ...
                    val fileName = call.argument<String>("fileName") ?: "mechcalc-backup.json"
