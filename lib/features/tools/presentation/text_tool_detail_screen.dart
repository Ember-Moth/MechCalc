...
class _TextToolDetailScreenState extends State<TextToolDetailScreen> {
  ...
  String _defaultInput(String id) {
    return switch (id) {
      ...
      'base64' => 'MechCalc',
      'url_codec' => 'MechCalc 工具箱',
      'json_format' => '{"name":"MechCalc","tools":["calculator","units","notes"]}',
      'ascii_unicode' => 'MechCalc',
      'bitwise' => '12 5',
      'checksum' => 'MechCalc',
      'uuid' => '',
      'jwt_decode' => 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJOZWtvQ2FsYyIsImV4cCI6MTg5MzQ1NjAwMH0.signature',
      'query_params' => 'https://example.com/search?q=MechCalc&page=1',
      'html_entities' => '<div class="name">MechCalc & Tools</div>',
      'regex_test' => r'\d+\nMechCalc 2026 build 42',
      'text_stats' => 'MechCalc\n全能计算工具箱',
