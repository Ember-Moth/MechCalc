      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            SettingsGroup(
              children: [
                SettingsTile(icon: Icons.info_outline, title: '关于 MechCalc', value: 'v1.0.0-beta.1', onTap: _showAbout),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text('MechCalc', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: scheme.onSurface)),
