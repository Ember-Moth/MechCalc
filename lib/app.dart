...
class MechCalcApp extends StatefulWidget {
  const MechCalcApp({super.key});

  @override
  State<MechCalcApp> createState() => _MechCalcAppState();
}

class _MechCalcAppState extends State<MechCalcApp> {
              ...
              child: ScaleTransition(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('MechCalc', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: scheme.onSurface)),
