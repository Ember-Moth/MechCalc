...
import 'package:mechcalc/application/controllers/notes_controller.dart';
import 'package:mechcalc/data/local/app_database.dart';
import 'package:mechcalc/data/models/history_item.dart';
import 'package:mechcalc/data/models/note_item.dart';
...
void main() {
  ...
  test('combines selected history and notes with separators', () {
    ...
    expect(text, startsWith('MechCalc 批量导出'));
