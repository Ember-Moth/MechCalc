...
import 'package:mechcalc/core/utils/backup_snapshot_validator.dart';
import 'package:mechcalc/data/local/app_database.dart';
import 'package:mechcalc/features/settings/presentation/settings_page.dart';

void main() {
  const backupChannel = MethodChannel('mechcalc/backup_file');
